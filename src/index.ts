...
export type { ITabsSliderProps, IOptionsTabsSlider } from './components/tabs-slider/tabs-slider.store';

//* - tooltip - *//
export { Tooltip } from './components/tooltip/tooltip';
export type { ITooltipState, ITooltipController, ITooltipProps } from './components/tooltip/tooltip.store';
